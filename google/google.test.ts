...
test('I can search Google', async () => {
    ...
    await driver.findElement(By.name('q')).sendKeys('Ron Swanson\n')
    ...
    await driver.findElement(By.name('q')).sendKeys('Michael Scott\n')

    await driver.findElement(By.xpath('(//a[text()="Images"])[1]'));
